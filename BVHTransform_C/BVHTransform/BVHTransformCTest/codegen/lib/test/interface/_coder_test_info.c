...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]E:/document and program/program_xyz_noitom/BVHTransform/BVHTransformCTest/test.m"),
                "context", 0);
  emlrtAddField(*info, emlrt_marshallOut("test2"), "name", 0);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 0);
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]E:/document and program/program_xyz_noitom/BVHTransform/BVHTransformCTest/test2.m"),
                "resolved", 0);
  emlrtAddField(*info, b_emlrt_marshallOut(1428219463U), "fileTimeLo", 0);
