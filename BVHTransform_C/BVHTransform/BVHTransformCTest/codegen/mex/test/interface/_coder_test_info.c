...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]E:/document and program/program_xyz_noitom/BVHTransform/BVHTransformCTest/test.m"),
                "context", 0);
  emlrtAddField(*info, emlrt_marshallOut("test1"), "name", 0);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 0);
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]E:/document and program/program_xyz_noitom/BVHTransform/BVHTransformCTest/test1.m"),
                "resolved", 0);
  emlrtAddField(*info, b_emlrt_marshallOut(1428218849U), "fileTimeLo", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("test"));
