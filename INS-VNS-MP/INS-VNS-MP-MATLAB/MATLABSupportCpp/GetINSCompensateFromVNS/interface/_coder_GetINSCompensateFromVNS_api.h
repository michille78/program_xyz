...
extern void GetINSCompensateFromVNS_api(const mxArray * const prhs[5], const mxArray *plhs[3]);
extern void GetINSCompensateFromVNS_xil_terminate(void);
extern void GetINSCompensateFromVNS(struct0_T InertialData, struct1_T otherMakers[3600], double compensateRate, int CalStartVN_in, int CalEndVN_in, double InertialPositionCompensate[34560], double HipDisplacementNew[34560]);
