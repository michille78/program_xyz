/*
 * _coder_GetINSCompensateFromVNS_mex.c
 *
...
static void GetINSCompensateFromVNS_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  if (nrhs != 5) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:WrongNumberOfInputs", 5, mxINT32_CLASS, 5, mxCHAR_CLASS, 23, "GetINSCompensateFromVNS");
  } else if (nlhs > 3) {
...
/* End of code generation (_coder_GetINSCompensateFromVNS_mex.c) */
