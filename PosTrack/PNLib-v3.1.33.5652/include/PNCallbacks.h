...
// Prop data callback
typedef void(__stdcall *PNEventPropDataCallback)(void* customObject, int avatarIndex, TEST_PropData* data);
...
typedef void(__stdcall *PNEventContactDataCallback)(void* customObject, int avatarIndex, FrameContactData* contactData);
...
// 重心矢量
typedef void(__stdcall *PNEventBodyCenterMassCallback)(void* customObject, int avatarIndex, char* data);
// 动作识别：身体倾斜矢量
